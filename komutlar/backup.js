      ...
      let guildsonlyEmbed = new RichEmbed()
        ...
        .setDescription(
          `Bu komutu özel mesajlarda kullanamazsın.
            ...
            [Destek](https://discord.gg/tST5gzd)`
        )
        .setColor("BLACK");
...
[Destek](https://discord.gg/tST5gzd)`);
        ...
        let cantfindbackup = new RichEmbed()
          ...
          .setDescription("[Destek](https://discord.gg/tST5gzd)")
          .setColor("BLACK");
        if (!backups[message.author.id][code])
          return message.channel.send(cantfindbackup);
...
`
          ...
          .setDescription(
            `
                e!yedek al             Sunucunuzu yedek alırsınız.
                e!yedek sil            Sunucu yedeğinizi silersiniz.
                e!yedek bilgi          Sunucu yedeğiniz hakkında bilgi alırsınız.
                e!yedek yükle          Sunucu yedeğinizi yüklersiniz.
                e!yedek temizle        Tüm yedeklerinizi silersiniz.
`
          )
          .addBlankField()
          .setColor("BLACK");
